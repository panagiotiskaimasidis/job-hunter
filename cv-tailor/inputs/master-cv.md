# Master CV — Panagiotis Kaimasidis
<!-- SOURCE OF TRUTH — never edit during a tailoring run; update only between applications -->

## Contact Details
- **Name:** Panagiotis Kaimasidis
...
Mechanical & Aeronautical Engineer (MSc, 8.36/10, University of Patras) with hands-on experience spanning FMCG process engineering at Procter & Gamble, health & safety leadership on a LEED-certified construction project, and aeronautical maintenance with the Hellenic Air Force. Proven record of applying data-driven analysis, systematic RCA, and cross-functional collaboration to eliminate waste, improve reliability, and meet rigorous operational standards. Seeking early-career engineering roles in Ireland or the EU where technical depth and continuous improvement mindset can deliver measurable impact.

---

## Education

### MSc — Mechanical & Aeronautical Engineering
**University of Patras** | Patras, Greece | Graduated: October 2025
- Overall grade: **8.36 / 10** (Excellent)
...
### Core Engineering
- Process Optimisation, Loss & Waste Reduction, Root Cause Analysis (RCA)
- QA Automation, Computer Vision QC
- Supply Chain Resilience, Spare Parts Management
- 5S Standards, Run to Standard (R2S), Asset Reliability
- Health & Safety (HSE), Hazard Identification & Risk Assessment (HIRA)
- LEED Green Building Standards
- Additive Manufacturing (Wire DED), Numerical Simulation, FEA (conceptual)
